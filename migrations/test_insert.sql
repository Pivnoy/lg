insert into "user"(uuid, email, password) values
                                              ('47e94c22-933d-4029-9752-dad3cd53a85b','bebra228@mail.ru', 'qwerty1234'),
                                              ('88ec4f5a-1989-4016-8684-8a9dd89d1d73', 'jopa@gmail.com', 'asdf'),
                                              ('6e07758f-bb73-49ed-a9d7-0ac4e32064f5','admin@admin.com', 'admin1'),
                                              ('753a2846-a6ef-4970-9693-41d66a55210f', 'roma@grek.chechnya', 'ya_ne_chach');
...
insert into profile(user_uuid, firstname, lastname, patronymic, country_uuid, city_uuid,
                    ...
                    graduation_year, employment_uuid, experience, achievement_uuid, team_uuid, specialization_uuid, company_uuid) VALUES
...
insert into project(uuid, "name", description, category_uuid, project_link, presentation_link, creator_uuid, is_visible) VALUES
                                                                                                                             ('e153b3a7-ca0c-4fc7-b500-efaef1bd73cd', 'Закрытие академов', 'Планируем жесточайше ботать чтобы закрыть все академы и долги', '13dadff0-98f4-438b-a803-65b3c7e4d833', 'https://docs.google.com/document/d/1yTMA8CKSxGP3-H_PPTIxDdm_TnUx87uTLiyKCIYPtik/edit', 'https://miro.com/app/board/uXjVPahvELM=/', '47e94c22-933d-4029-9752-dad3cd53a85b', 'visible'),
                                                                                                                             ('fa044ee2-cebd-484d-9697-9f8b25646188', 'Попить пива', 'Предлагаю всем смачно попить пыва на выходных на ветеранах', '45e07768-da80-4681-a01a-80654e40059b', 'https://ru.wikipedia.org/wiki/%D0%9F%D0%B8%D0%B2%D0%BE', 'https://pptcloud.ru/obzh/mify-o-pive', '88ec4f5a-1989-4016-8684-8a9dd89d1d73', 'visible');
